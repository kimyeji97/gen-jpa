...
src_path = '/Users/yjkim/project_sources/web-platform-init/src/main/java/'
_package_path_info = gen.PackagePathInfo(
    project_src_path=src_path
    , core_repository_path=src_path + 'com/yjkim/web/platform/init/framework/core/gen/repository'
    , core_entity_path=src_path + 'com/yjkim/web/platform/init/framework/core/gen/entity'
    , core_entity_id_path=src_path + 'com/yjkim/web/platform/init/framework/core/gen/id'
    ...
    , core_entity_id_package='com.yjkim.web.platform.init.framework.core.gen.id'
    , core_repository_package='com.yjkim.web.platform.init.framework.core.gen.repository'
    , core_converter_package='com.yjkim.web.platform.init.framework.core.gen.converter'
)
...
def generate_jpa_files():
    ...
    if len(category_targets) == 0 or category in category_targets:
        ...
        gen.generate_jpa_files(gen_targets, 'tb_sample', category, repository_package, entity_package)
